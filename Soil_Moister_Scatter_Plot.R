...
Plot_0306 <- ggplot(Soil_Data_Clean, aes(x=Date, y=`Temperature TFO 0306`, group = 1)) +
  ...
  geom_line(aes(color = "Temperature"), size = 1.5) + 
  geom_line(aes(y=`Water Content TFO 0306`*100, group = 1, color = "Water Content"), size = 1.5) +
  scale_y_continuous(
...
Plot_0101 <- ggplot(Soil_Data_Clean, aes(x=Date, y=`Temperature RBP 0101`, group = 1)) +
  ...
  geom_line(aes(color = "Temperature"), size = 1.5) + 
  geom_line(aes(y=`Water Content RBP 0101`*100, group = 1, color = "Water Content"), size = 1.5) +
  scale_y_continuous(
...
Plot_0300 <- ggplot(Soil_Data_Clean, aes(x=Date, y=`Temperature RBP 0300`, group = 1)) +
  ...
  geom_line(aes(color = "Temperature"), size = 1.5) + 
  geom_line(aes(y=`Water Content RBP 0300`*100, group = 1, color = "Water Content"), size = 1.5) +
  scale_y_continuous(
...
Soil_Sensor_Plots <- (Plot_0107 + Plot_0117 + Plot_0204 + Plot_0214) | (Plot_0101 + Plot_0103 + Plot_0105 + Plot_0300)

Soil_Sensor_Plots + plot_annotation(
  title = "Soil Temperature and Water Content in TFO and RBP",
